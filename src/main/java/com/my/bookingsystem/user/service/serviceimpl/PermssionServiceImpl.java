package com.my.bookingsystem.user.service.serviceimpl;

import com.my.bookingsystem.user.entity.Permission;
import com.my.bookingsystem.user.repository.PermissionRepository;
import com.my.bookingsystem.user.service.PermissionService;
